...
1. Search in chrome just say "search in chrome".
1. Tell you the time by saying "time" or "what time is it" or "what is the time" or "tell me the time".
1. Tell you the date by saying "date" or "what date is it" or "what is the date" or "tell me the date".
1. Play music by saying "play music" or "play a song" or "play a song now" or "play music now" 
1. Play any video from YouTube by saying "play how to make a cake" will open a YouTube video tutorial teaching how to make a cake.
1. Play specific music say play lonely song by saying "play lonely song" or "play a song called lonely song" or "play a song called lonely song now" or "play lonely song now" or "play a song called lonely song now".
1. Get new for today by saying "get new for today" or "get new for today now" or "get new for today now".
1. Generate a random password by saying "generate a password" or "generate a random password".
1. Generate a random number by saying "generate a number" or "generate a random number".
1. Change your name by saying "change my name to (your name)" or "call me (your name)".
1. Send a mail by saying "send a mail to (your mail ID)" or "send a mail to (your mail ID) with (your message)".
1. Lock the screen by saying "lock the screen" or "lock window" or "lock screen".
1. Shutdown the computer by saying "shutdown the computer" or "shutdown the computer now" or "shutdown system".
1. Empty the recycle bin by saying "empty the recycle bin" or "empty recycle bin".
1. Stop listening by saying "stop listening" or "stop listening now" or "don't listen" or "don't listen now".
1. Tell you the location of a place by saying "where is (the name of the place)".
1. Restart the computer by saying "restart the computer" or "restart the computer now" or "restart system" or "reboot the computer" or "reboot the computer now" or "reboot system".
1. Hibernate the computer system by saying "hibernate the computer" or "hibernate the computer now" or "hibernate system" .
1. Logout the computer by saying "logout the computer" or "logout the computer now" or "logout system" or "sign out the computer" or "sign out the computer now" or "sign out system".
1. Write a note by saying "write a note" or "write note" or "write a note now" or "write note now" with further of including the time and date by saying yes or no.
1. Read a note by saying "read a note" or "read note" or "read a note now" or "read note now".
1. Delete a note by saying "delete a note" or "delete note" or "delete a note now" or "delete note now".
1. Show all notes by saying "show all notes" or "show all notes now" or "show all notes now".
...
1. Answer to many questions like :-
   ...
   1. What is your favorite actress?
   1. And many more...
1. Exit the application just by saying "exit the application" or "exit" or "goodbye" or "bye".
