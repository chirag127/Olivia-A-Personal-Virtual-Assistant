...
def enjoy_watching():
    ...
    while True:
        ...
        elif "speed" in query and "test" in query:
        ...
        elif ("stop" in query and "watching" in query) or (
            "close" in query and "video" and "tab" not in query
        ):
...
def wishMe():
    ...
    if hour >= 0 and hour < 12:
        ...
        hour >= 12 and hour < 18
    ):  # if time is between 12 and 18 then say good afternoon
...
def givejoke():
    response_API = requests.get("https://icanhazdadjoke.com/slack")
...
:::..::::::.......:::::::.......:::........::....:::::...:::::....::..:::::..::""")
    ...
    while running:
        ...
        # search in chrome when the query is 'search'
            ...
            webbrowser.get(chromepath).open("https://www.google.com/search?q=" + search)
        ...
        # if 'open' is in query and 'notepad' is in query then open notepad
            ...
            "lock window" in query
            or "lock screen" in query
            or "lock the screen" in query
        ):
            ...
            query == "quit"
            or "olivia quit" in query
            or "olivia bye" in query
            or query == "bye"
            or query == "exit"
            or query == "goodbye"
            or query == "bye bye"
        ...
        #                 speak("Sorry Sir, I am not able to fetch the time")
            ...
            if "control panel" in query:
                ...
                githubPath = (
                    "C:\\Users\\hp\\AppData\\Local\\GitHubDesktop\\GitHubDesktop.exe"
                )
                ...
                microsoftStorePath = (
                    "C:\\Program Files\\Microsoft Store\\Microsoft Store.exe"
                )
                ...
                microsoftMailPath = (
                    "C:\\Program Files\\Microsoft\\Windows Live Mail\\wlmail.exe"
                )
